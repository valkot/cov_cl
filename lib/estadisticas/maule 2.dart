...
class Maule extends StatefulWidget
{
  @override
  _MauleState createState() => _MauleState();
}


class _MauleState extends State<Maule>
{
  ...
  Future<String> getData() async 
  {
    ...
    (
      Uri.encodeFull("http://186.64.121.251/app-urology/wsCovidComunasCompleto.php?region=07"),//http://186.64.121.251/app-urology/getCovidComunas.php
      headers: 
      {
