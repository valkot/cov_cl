...
class Aysen extends StatefulWidget
{
  @override
  _AysenState createState() => _AysenState();
}


class _AysenState extends State<Aysen>
{
  ...
  Future<String> getData() async 
  {
    ...
    (
      Uri.encodeFull("http://186.64.121.251/app-urology/wsCovidComunasCompleto.php?region=11"),//http://186.64.121.251/app-urology/getCovidComunas.php
      headers: 
      {
