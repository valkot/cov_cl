...
class Metropolitana extends StatefulWidget
{
  @override
  _MetropolitanaState createState() => _MetropolitanaState();
}


class _MetropolitanaState extends State<Metropolitana>
{
  ...
  Future<String> getData() async 
  {
    ...
    (
      Uri.encodeFull("http://186.64.121.251/app-urology/wsCovidComunasCompleto.php?region=13"),//http://186.64.121.251/app-urology/getCovidComunas.php
      headers: 
      {
    ...
    if(elTimer > 1)
    {
      ...
      (
        ...
        (
          ...
          title: Text('Región Metropolitana'),
        ),
        body: Container
        (
