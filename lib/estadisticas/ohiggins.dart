...
class Ohiggins extends StatefulWidget
{
  @override
  _OhigginsState createState() => _OhigginsState();
}


class _OhigginsState extends State<Ohiggins>
{
  ...
  Future<String> getData() async 
  {
    ...
    (
      Uri.encodeFull("http://186.64.121.251/app-urology/wsCovidComunasCompleto.php?region=06"),//http://186.64.121.251/app-urology/getCovidComunas.php
      headers: 
      {
    ...
    if(elTimer > 1)
    {
      ...
      (
        ...
        (
          ...
          title: Text("Región de O'higgins"),
        ),
        body: Container
        (
