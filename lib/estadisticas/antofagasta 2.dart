...
class Antofagasta extends StatefulWidget
{
  @override
  _AntofagastaState createState() => _AntofagastaState();
}


class _AntofagastaState extends State<Antofagasta>
{
  ...
  Future<String> getData() async 
  {
    ...
    (
      Uri.encodeFull("http://186.64.121.251/app-urology/wsCovidComunasCompleto.php?region=02"),//http://186.64.121.251/app-urology/getCovidComunas.php
      headers: 
      {
  ...
  Widget build(BuildContext context) 
  {
    if(elTimer > 1)
    {
      ...
      (
        appBar: AppBar
        (
          title: Text('Región de Antofagasta'),
        ),
        body: Container
        (
