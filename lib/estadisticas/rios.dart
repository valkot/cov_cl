...
class _RiosState extends State<Rios>
{
  ...
  Future<String> getData() async 
  {
    ...
    (
      Uri.encodeFull("http://186.64.121.251/app-urology/wsCovidComunasCompleto.php?region=14"),//http://186.64.121.251/app-urology/getCovidComunas.php
      headers: 
      {
