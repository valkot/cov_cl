...
class Arica extends StatefulWidget
{
  @override
  _AricaState createState() => _AricaState();
}


class _AricaState extends State<Arica>
{
  ...
  Future<String> getData() async 
  {
    ...
    (
      Uri.encodeFull("http://186.64.121.251/app-urology/wsCovidComunasCompleto.php?region=15"),//http://186.64.121.251/app-urology/getCovidComunas.php
      headers: 
      {
  ...
  Widget build(BuildContext context) 
  {
    ...
    (
      appBar: AppBar
      (
        title: Text('Región de Arica y Parinacota'),
      ),
      body: Container
      (
