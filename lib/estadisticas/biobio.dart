...
class Biobio extends StatefulWidget
{
  @override
  _BiobioState createState() => _BiobioState();
}


class _BiobioState extends State<Biobio>
{
  ...
  Future<String> getData() async 
  {
    ...
    (
      Uri.encodeFull("http://186.64.121.251/app-urology/wsCovidComunasCompleto.php?region=08"),//http://186.64.121.251/app-urology/getCovidComunas.php
      headers: 
      {
