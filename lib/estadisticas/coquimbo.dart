...
class Coquimbo extends StatefulWidget
{
  @override
  _CoquimboState createState() => _CoquimboState();
}


class _CoquimboState extends State<Coquimbo>
{
  ...
  Future<String> getData() async 
  {
    ...
    (
      Uri.encodeFull("http://186.64.121.251/app-urology/wsCovidComunasCompleto.php?region=04"),//http://186.64.121.251/app-urology/getCovidComunas.php
      headers: 
      {
