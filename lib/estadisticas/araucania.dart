...
class Araucania extends StatefulWidget
{
  @override
  _AraucaniaState createState() => _AraucaniaState();
}


class _AraucaniaState extends State<Araucania>
{
  ...
  Future<String> getData() async 
  {
    ...
    (
      Uri.encodeFull("http://186.64.121.251/app-urology/wsCovidComunasCompleto.php?region=09"),//http://186.64.121.251/app-urology/getCovidComunas.php
      headers: 
      {
    ...
    if(elTimer > 1)
    {
      ...
      (
        ...
        (
          ...
          title: Text('Región de la Araucanía'),
        ),
        body: Container
        (
