...
class Valparaiso extends StatefulWidget
{
  @override
  _ValparaisoState createState() => _ValparaisoState();
}


class _ValparaisoState extends State<Valparaiso>
{
  ...
  Future<String> getData() async 
  {
    ...
    (
      Uri.encodeFull("http://186.64.121.251/app-urology/wsCovidComunasCompleto.php?region=05"),//http://186.64.121.251/app-urology/getCovidComunas.php
      headers: 
      {
  ...
  Widget build(BuildContext context) 
  {
    ...
    (
      appBar: AppBar
      (
        title: Text("Región de Valparaíso"),
      ),
      body: Container
      (
