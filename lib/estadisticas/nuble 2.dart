...
class Nuble extends StatefulWidget
{
  @override
  _NubleState createState() => _NubleState();
}


class _NubleState extends State<Nuble>
{
  ...
  Future<String> getData() async 
  {
    ...
    (
      Uri.encodeFull("http://186.64.121.251/app-urology/wsCovidComunasCompleto.php?region=16"),//http://186.64.121.251/app-urology/getCovidComunas.php
      headers: 
      {
