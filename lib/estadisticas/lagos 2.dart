...
class _LagosState extends State<Lagos>
{
  ...
  Future<String> getData() async 
  {
    ...
    (
      Uri.encodeFull("http://186.64.121.251/app-urology/wsCovidComunasCompleto.php?region=10"),//http://186.64.121.251/app-urology/getCovidComunas.php
      headers: 
      {
  ...
  Widget build(BuildContext context) 
  {
    ...
    (
      appBar: AppBar
      (
        title: Text('Región de Los Lagos'),
      ),
      body: Container
      (
