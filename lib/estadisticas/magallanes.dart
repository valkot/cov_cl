...
class Magallanes extends StatefulWidget
{
  @override
  _MagallanesState createState() => _MagallanesState();
}


class _MagallanesState extends State<Magallanes>
{
  ...
  Future<String> getData() async 
  {
    ...
    (
      Uri.encodeFull("http://186.64.121.251/app-urology/wsCovidComunasCompleto.php?region=12"),//http://186.64.121.251/app-urology/getCovidComunas.php
      headers: 
      {
    ...
    if(elTimer > 1)
    {
      ...
      (
        ...
        (
          ...
          title: Text('Región de Magallanes'),
        ),
        body: Container
        (
